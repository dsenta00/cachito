...
class ResourceTest extends RestTestBase {
    ...
    void givenPersonIsSet_whenPost_thenPersonIsPersisted() {
        ...
        ResourceAction.post().stream().post(resource, person, getPersistence());
    ...
    void givenEmployeeIsSet_whenPost_thenEmployeeIsPersisted() {
        ...
        Entity persistedEmployee = ResourceAction.post().stream().post(employeeResource, employee, getPersistence());
    ...
    void givenPersonWithNoFirstNameAndLastNameIsSet_whenPost_thenEmployeeWithNoNameIsPersisted() {
        ...
        Entity persistedPerson = ResourceAction.post().stream().post(personResource, person, getPersistence());
    ...
    void givenManagerIsSet_whenPost_thenManagerIsPersisted() {
        ...
        Entity persistedManager = ResourceAction.post().stream().post(managerResource, manager, getPersistence());
    ...
    void givenTwoManagerWithSameEmployeeIsSet_whenPost_thenBothManagerManagesSameEmployee() {
        ...
        ResourceAction.post().stream().post(managerResource, managerIvo, getPersistence());

        Manager managerMatko = createMatkoZvonicAsManager();
        employee.setId(2L);
        managerMatko.getEmployees().add(employee);
        Entity persistedMatko = ResourceAction.post().stream().post(managerResource, managerMatko, getPersistence());
    ...
    void givenEmployeeWithForcedIdIsSet_whenPost_thenExceptionIsThrown() {
        ...
        employee.setId(15L);
        Resource employeeResource = PersistableResource.get(getEmployeeClazz(), getPersistence());
        assertThrows(PostForceIdException.class, () -> ResourceAction.post().stream().post(employeeResource, employee, getPersistence()));
    }
    ...
    void givenManagerWithForcedIdIsSet_whenPost_thenExceptionIsThrown() {
        ...
        manager.setId(15L);
        Resource managerResource = PersistableResource.get(getManagerClazz(), getPersistence());
        assertThrows(PostForceIdException.class, () -> ResourceAction.post().stream().post(managerResource, manager, getPersistence()));
    }
    ...
    void givenTwoManagersAreSet_whenPutFirstToSameNameAsSecond_thenConstraintExceptionIsThrown() {
        ...
        Entity matkoZvonicAsEntity = ResourceAction.post().stream().post(managerResource, matkoZvonicAsManager, getPersistence());
        ...
        Entity ivoBilicAsEntity = ResourceAction.post().stream().post(managerResource, ivoBilicAsManager, getPersistence());
    ...
    void givenManagersAndEmployeesAreSet_whenGet_thenGetReturnsDataAsExpected() {
        ...
        Entity anteMilinEntity = ResourceAction.post().stream().post(employeeResource, anteMilin, getPersistence());
        ...
        Entity zvonimirAnticevicEntity = ResourceAction.post().stream().post(employeeResource, zvonimirAnticevic, getPersistence());
        ...
        Entity ivoBilicEntity = ResourceAction.post().stream().post(managerResource, ivoBilic, getPersistence());
        ...
        Entity matkoZvonicEntity = ResourceAction.post().stream().post(managerResource, matkoZvonic, getPersistence());
    ...
    void givenBillsAreSet_whenGetByQuery_thenGetIsOk() {
        ...
        anteMilin.setId(Objects.requireNonNull(ResourceAction.post().stream().post(personResource, anteMilin, getPersistence())).getId());
        ivoBilic.setId(Objects.requireNonNull(ResourceAction.post().stream().post(personResource, ivoBilic, getPersistence())).getId());
        ...
        anteMilinBillMorning.setId(Objects.requireNonNull(ResourceAction.post().stream().post(billResource, anteMilinBillMorning, getPersistence())).getId());
        ...
        anteMilinBillNoon.setId(Objects.requireNonNull(ResourceAction.post().stream().post(billResource, anteMilinBillNoon, getPersistence())).getId());
        ...
        anteMilinBillEvening.setId(Objects.requireNonNull(ResourceAction.post().stream().post(billResource, anteMilinBillEvening, getPersistence())).getId());
        ...
        ivoBilicBillMorning.setId(Objects.requireNonNull(ResourceAction.post().stream().post(billResource, ivoBilicBillMorning, getPersistence())).getId());
        ...
        ivoBilicBillNoon.setId(Objects.requireNonNull(ResourceAction.post().stream().post(billResource, ivoBilicBillNoon, getPersistence())).getId());
